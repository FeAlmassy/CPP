...
function gerar_carteiras_hpc(acoes::Vector{String}, passo::Int; investimento::Union{Float64, Nothing}=nothing, start_dt::String="2023-01-01", end_dt::String="2026-06-30")
...
# Execução Principal
# ---------------------------------------------------------
# Lista com 12 ações (ITSA4.SA substituiu ELET3)
doze_acoes = ["PETR3.SA", "VALE3.SA", "EMBJ3.SA", "ITUB4.SA", "BBDC4.SA", "BBAS3.SA", "ITSA4.SA", "WEGE3.SA", "RENT3.SA", "SUZB3.SA", "ABEV3.SA", "B3SA3.SA"]

alocacao = gerar_carteiras_hpc(doze_acoes, 5, investimento=10_000.0)
display(alocacao)